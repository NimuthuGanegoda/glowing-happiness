...
const carImageElement = document.getElementById('carImagePreviewable');

// Function to convert SVG to data URL for preview
...
// Open preview when clicking on car image
if (carImageElement) {
    carImageElement.addEventListener('click', function() {
